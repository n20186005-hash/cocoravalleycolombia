...
const photoFiles = [
  ...
  'cocora-valley (8).jpg',
  'cocora-valley (9).jpg',
  'cocora-valley (10).jpg',
  'cocora-valley (11).jpg',
  'cocora-valley (12).jpg',
  'cocora-valley (13).jpg',
  'cocora-valley (14).jpg',
  'cocora-valley (15).jpg',
  'cocora-valley (16).jpg',
  'cocora-valley (17).jpg',
];
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="relative">
            ...
            <div className="flex justify-center mt-8">
              <a
                href="https://maps.app.goo.gl/BZN9DW5ac8TXbF3C9"
                target="_blank"
